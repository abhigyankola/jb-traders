...
const Contact = () => {
    useDocTitle('JB Traders | Send us a message')
    ...
    const sendEmail = (e) => {
        ...
        let formErrors = {};
        if (!firstName.trim()) formErrors.first_name = "First name is required";
        ...
        fData.append('service_id', 'service_ffsdt7z');
        fData.append('template_id', 'template_4hckmgs');
        fData.append('user_id', 'Jj6QotKivt7ScIlDn');
            ...
            <div id='contact' className="flex justify-center items-center mt-8 w-full bg-white py-12 lg:py-24 ">
                ...
                <form onSubmit={sendEmail}>
                    ...
                    <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                        <div className="flex">
                            <h1 className="font-bold text-center lg:text-left text-black-900 uppercase text-4xl">Send us a message</h1>
                        </div>
                            ...
                            <div className="flex flex-col text-white">
                                ...
                                <div className="flex my-4 w-2/3 lg:w-3/4">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <p className="text-gray-400">2-2-1125/57, Lakshmi Nivas, New Nallakunta, Hyderabad, Telangana 500044</p>
                                    </div>
                                </div>
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        ...
                        <p className="text-gray-400">Tel: 08055384406</p> */}
                            ...
                            <div className='mt-5'>
                                ...
                                <p className="text-gray-400">kmanish2103@gmail.com</p>
                            </div>
